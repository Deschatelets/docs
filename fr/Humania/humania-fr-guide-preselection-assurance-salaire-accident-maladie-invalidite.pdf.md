...
**Usage de drogues** : Non couvert (sédatifs, opiacés, stimulants illicites). Alternative : Assurance sans examen sur [https://assem.humania.ca/accueil](https://assem.humania.ca/accueil).
...
| **Cancer du sein** | Âge, date, type, traitement, récidive | RMT | In situ: différé 1 an, ensuite exclusion. Selon stade: +25% durée 5 ans exclusion à refus. |
...
| **Hypercholestérolémie** | Âge, date, médication, taux actuel, tension | Profil sanguin/urine, signes vitaux | Standard si contrôlé et taux normaux. |
| **Hypertension artérielle** | Âge, date, médication, tension actuelle | Profil sanguin/urine, signes vitaux | Standard si contrôlé et tension normale. |
| **MPOC / Emphysème / Bronchite chronique** | Date, traitement, sévérité, tabac | RMT | Non-fumeur: +50% à refus. Fumeur: +100% à refus. |
| **Œsophage de Barrett** | Sévérité, traitement | RMT | +50% à refus; exclusion possible. |
| **Parkinson** | - | - | Refus. |
| **Schizophrénie** | Épisodes, date dernier, arrêt, traitement, hospitalisation, suicide | Questionnaire troubles nerveux, RMT | 0-10 ans: refus; ensuite +100%, durée 5 ans exclusion. Refus possible. |
...
**Notes** : Indemnité mensuelle = 100% invalidité totale + 100% assurances invalidité (12 mois, non remplacées) + 50% option additionnelle. L'assureur peut exiger rapports/examens supplémentaires.
